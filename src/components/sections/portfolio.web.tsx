...
const CASES = [
  {
    ...
    result: 'Using M-Auxis campaign automation and creator discovery, they scaled to 7 platforms, partnered with 14 micro-influencers and tripled their reach in 60 days.',
    stats: [
  ...
  },
  {
    ...
    result: 'M-Auxis connected both ad accounts, auto-tracked conversions and moved leads into a structured AI CRM pipeline — cutting CAC by 38%.',
    stats: [
    ...
    mockup: () => (
      <svg viewBox="0 0 280 180" style={{ width: '100%', height: 'auto', maxWidth: '280px' }} fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="140" y="30" textAnchor="middle" fontFamily="monospace" fontWeight="700" fontSize="10" fill="var(--bg-cream)">m-auxis.ai / ads-dashboard</text>
        {/* Stat pills */}
  ...
  },
  {
    ...
    result: 'With M-Auxis creator discovery + contract + payment workflow, they signed 6 influencer deals and went live in under a week — something that used to take a month.',
    stats: [
  ...
  },
  {
    ...
    result: 'M-Auxis unified all channels, automated weekly content publishing and surfaced unified analytics — growing LinkedIn followers 4× in 90 days.',
    stats: [
          ...
          <div style={{ textAlign: 'center', marginBottom: isMobile ? '36px' : '60px' }}>
            ...
            <ScrollReveal delay={200}>
              <p style={{
                ...
                See how teams use M-Auxis to grow faster, save time and run campaigns that actually convert.
              </p>
            </ScrollReveal>
          </div>
