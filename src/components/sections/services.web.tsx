      ...
      >
        <div style={{ width: '100%', maxWidth: '1400px', margin: '0 auto', padding: isMobile ? '0 16px' : '0 24px' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: isMobile ? '36px' : '64px' }}>
            ...
            >
              From content creation to customer acquisition, sales automation and creator partnerships, M-Auxis brings your entire growth engine into one AI-powered platform.
            </p>
          </div>
