...
function ConnectIllustration() {
  return (
    <svg viewBox="-25 -25 310 270" style={{ width: '100%', height: '100%', maxWidth: '260px', maxHeight: '100%' }} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="130" y="106" textAnchor="middle" fontFamily="var(--font-oswald)" fontWeight="800" fontSize="10" fill="var(--color-dark)">M-Auxis</text>
          ...
          <div style={{ textAlign: 'center', marginBottom: isMobile ? '36px' : '60px' }}>
            ...
            <ScrollReveal delay={200}>
              <p style={{
                ...
                From your first campaign to automated lead generation and sales growth, M-Auxis helps you launch, manage, and scale from one platform.
              </p>
            </ScrollReveal>
          </div>
